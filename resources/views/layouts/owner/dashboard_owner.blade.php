    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 flex flex-col space-y-6 min-w-0">
            ...
            <div class="bg-white p-6 rounded-xl shadow overflow-x-auto font-['Roboto']"
                x-data="{
                    patients: @json($patientStatus),  // ← Data dari controller (VIEW)
                    ...
                    get filteredPatients() {
                        return this.patients.filter(p => {
                            return (
                                ...
                                (this.statusFilter === '' || p.status_display === this.statusFilter) &&
                                ...
                                <td class="py-2 px-3">
                                    <div class="relative" x-data="{ openStatus:false }">
                                        ...
                                        <button @click="openStatus = !openStatus"
                                            ...
                                            :class="{
                                                'bg-green-100 text-green-700': patient.status_display==='Completed',
                                                'bg-blue-100 text-blue-700': patient.status_display==='In Progress',
                                                'bg-gray-100 text-gray-700': patient.status_display==='Scheduled',
                                                'bg-red-100 text-red-700': patient.status_display==='Cancelled'
                                            }">
                                            <span x-text="patient.status_display"></span>
                                        ...
                                        <div x-show="openStatus" @click.away="openStatus=false"
                                            ...
                                            <template x-for="st in ['Completed','In Progress','Scheduled','Cancelled']">
                                                <button
                                                    ...
                                                    @click="patient.status_display = st; openStatus=false"
                                                    x-text="st"></button>
                                            </template>
