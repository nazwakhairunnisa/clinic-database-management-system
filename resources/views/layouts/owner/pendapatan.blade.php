    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 pt-6">
        ...
        <div class="flex w-full items-center justify-between gap-3">
            ...
            <div class="relative flex-grow">
                <input type="text" placeholder="Search Pendapatan"
    ...
    <div class="bg-white rounded-2xl shadow p-4 sm:p-6 overflow-x-auto transition-all duration-300">
        <table class="min-w-[800px] w-full text-sm text-left border-collapse">
            ...
            <tbody class="text-gray-700">
                @foreach([
                    ['no'=>1,'name'=>'Alat 1','jumlah'=>'Rp 350.000','date'=>'25 Oktober 2025','payment'=>'Cash'],
                    ['no'=>2,'name'=>'Alat 2','jumlah'=>'Rp 350.000','date'=>'25 Oktober 2025','payment'=>'Debit'],
                    ['no'=>3,'name'=>'Obat 1','jumlah'=>'Rp 350.000','date'=>'25 Oktober 2025','payment'=>'QRIS'],
                    ['no'=>4,'name'=>'Obat 2','jumlah'=>'Rp 350.000','date'=>'25 Oktober 2025','payment'=>'Cash'],
                ] as $row)
