...
<div class="font-['Roboto'] bg-[#F8F6F1] min-h-screen flex justify-center items-start pt-8 sm:pt-12">
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-4xl p-6 sm:p-8 transition-all duration-300">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('owner.pasien.detail', $pasien->id_pasien) }}" class="text-gray-400 hover:text-gray-600 transition">
        ...
        {{-- Form --}}
        <form action="{{ route('owner.pasien.updateRekam', $pasien->id_pasien) }}" method="POST" class="space-y-5 text-sm text-gray-700">
            @csrf
            @method('PUT')
            ...
            <div class="pt-4 flex gap-3">
                ...
                <a href="{{ route('owner.pasien.detail', $pasien->id_pasien) }}" 
