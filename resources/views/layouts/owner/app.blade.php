...
<body x-data="{ sidebarOpen: false }" class="bg-[#F8F6F1] font-['Roboto']">
...
<aside
  ...
  <div class="flex-1 p-10 overflow-y-auto">
    ...
    <ul class="space-y-1.5 text-[#806B3F]">
      {{-- Dashboard --}}
      <li>
        <a href="{{ route('owner.dashboard') }}" class="flex items-center rounded-lg hover:bg-[#E9E1C5] text-[1rem]">
      ...
      <li>
        <div class="flex items-center justify-between pt-0 pb-0 cursor-pointer menu-toggle">
          <div class="flex items-center space-x-2">
            <iconify-icon icon="material-symbols:finance" class="text-xl text-black"></iconify-icon>
            <span class="uppercase text-[1rem] tracking-wider font-semibold leading-[1]">Keuangan</span>
          </div>
          <iconify-icon icon="tabler:chevron-down"
            class="text-sm text-black transition-transform duration-200 {{ $openKeuangan ? 'rotate-180' : '' }}"></iconify-icon>
        </div>
      ...
      <li>
        <div class="flex items-center justify-between pt-0 pb-0 cursor-pointer menu-toggle">
          <div class="flex items-center space-x-2">
            <iconify-icon icon="bxs:report" class="text-xl text-black"></iconify-icon>
            <span class="uppercase text-[1rem] tracking-wider font-semibold leading-[1]">Laporan</span>
          </div>
          <iconify-icon icon="tabler:chevron-down"
            class="text-sm text-black transition-transform duration-200 {{ $openLaporan ? 'rotate-180' : '' }}"></iconify-icon>
        </div>
