...
<head>
    ...
    <style>
        * {
        ...
        .badge-ewallet { background: #fff3cd; color: #856404; }
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @php
                        $badgeClass = match($row->metode_pembayaran) {
                            'cash' => 'badge-cash',
                            'transfer' => 'badge-transfer',
                            'ewallet' => 'badge-ewallet',
                            default => 'bg-gray-100 text-gray-700'
                        };
                        $label = match($row->metode_pembayaran) {
                            'cash' => 'Cash',
                            'transfer' => 'Transfer',
                            'ewallet' => 'E-Wallet',
                            default => '-'
    ...
    <div style="text-align: center; padding: 40px; color: #999;">
        <p>Tidak ada data pengeluaran untuk diekspor</p>
    </div>
    @endif
