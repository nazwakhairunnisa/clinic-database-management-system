...
<div class="max-w-full font-['Roboto',sans-serif]">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 pt-6">
        ...
        <div class="flex flex-wrap gap-2 sm:gap-3 items-center w-full sm:w-auto">
            ...
            {{-- SEARCH --}}
            <form method="GET" action="{{ route('owner.promo.index') }}" class="relative w-60">
            ...
            {{-- DATE PICKER --}}
            <form method="GET" action="{{ route('owner.promo.index') }}" id="dateFilterForm">
            ...
            @if(request('date') || request('search'))
                <a href="{{ route('owner.promo.index') }}"
            ...
            {{-- EXPORT (MOBILE ONLY) --}}
            <a href="{{ route('owner.promo.export') }}"
