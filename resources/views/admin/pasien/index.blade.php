...
<div class="font-['Roboto',sans-serif]">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 pt-6">
        ...
        <div class="flex w-full items-center justify-between gap-3">
            ...
            {{-- Search --}}
            <form method="GET" action="{{ route('admin.pasien.index') }}" class="relative flex-grow">
            ...
            <div class="flex space-x-2 sm:space-x-3 shrink-0">
                ...
                {{-- Export --}}
                <a href="{{ route('admin.pasien.export', request()->query()) }}"
    ...
    <div class="bg-white rounded-2xl shadow p-4 sm:p-6 overflow-x-auto">
        ...
        <table class="min-w-[1100px] w-full text-sm text-left border-collapse">
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="bg-white hover:bg-gray-50 transition-all duration-200 border-b border-gray-200">
                    ...
                    {{-- Rekam Medis --}}
                    <td class="px-4 py-3">
                        <a href="{{ route('admin.pasien.show', $row->id_pasien) }}"
                    ...
                    <td class="px-4 py-3 flex space-x-3">
                        {{-- Edit Rekam Medis --}}
                        <a href="{{ route('admin.pasien.editRekam', $row->id_pasien) }}"
                        ...
                        {{-- DELETE --}}
                        <form action="{{ route('admin.pasien.destroy', $row->id_pasien) }}" 
                              method="POST" 
        ...
        <div class="text-center py-8 text-gray-500">
            ...
            <a href="{{ route('admin.pasien.add') }}" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">
