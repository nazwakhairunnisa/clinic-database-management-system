    ...
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-4xl p-6 sm:p-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.pasien.editRekam', $pasien->id_pasien) }}" 
                    class="text-blue-600 hover:text-blue-800 transition"
                    title="Edit Rekam Medis">
                    <i class="fa-solid fa-edit text-xl"></i>
                </a>
                {{-- Close Button --}}
                <a href="{{ route('admin.pasien.index') }}" class="text-gray-400 hover:text-gray-600 transition">
        ...
        <div class="border border-yellow-300 bg-yellow-50 rounded-lg p-4 mb-6 text-center">
            <p class="text-yellow-700 mb-2">Rekam medis belum dibuat oleh dokter</p>
        </div>
        @endif
