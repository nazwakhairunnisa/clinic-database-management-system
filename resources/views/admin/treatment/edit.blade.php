...
<div class="font-['Roboto',sans-serif] bg-gray-100 min-h-screen flex justify-center items-start pt-10 sm:pt-14">
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-3xl p-6 sm:p-8 transition-all duration-300">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.treatment.index') }}" class="text-gray-400 hover:text-gray-600 transition">
        ...
        {{-- Form Edit --}}
        <form action="{{ route('admin.treatment.update', $treatment->id_treatment) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
