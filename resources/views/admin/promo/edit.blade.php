...
<div class="font-['Roboto',sans-serif] bg-[#F8F6F1] min-h-screen flex justify-center items-start pt-10 sm:pt-14">
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-4xl p-8 transition-all duration-300 relative">
        ...
        {{-- CLOSE BUTTON --}}
        <a href="{{ route('admin.promo.index') }}" class="absolute top-6 right-6 text-gray-500 hover:text-gray-700">
        ...
        {{-- FORM --}}
        <form action="{{ route('admin.promo.update', $promo->promo_id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
