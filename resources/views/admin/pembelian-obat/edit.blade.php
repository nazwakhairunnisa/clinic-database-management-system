...
<div class="font-['Roboto',sans-serif] bg-[#F8F6F1] min-h-screen flex justify-center items-start pt-10 sm:pt-14">
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-3xl p-6 sm:p-8 transition-all duration-300">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.pembelian-obat') }}" class="text-gray-400 hover:text-gray-600 transition">
        ...
        {{-- FORM --}}
        <form action="{{ route('admin.pembelian-obat.update', $pembelian->id_pembelian_obat) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="pt-2 flex space-x-3">
                ...
                <a href="{{ route('admin.pembelian-obat') }}"
