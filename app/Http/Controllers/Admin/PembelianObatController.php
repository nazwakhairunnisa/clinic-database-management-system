...
class PembelianObatController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pembelian-obat.index', compact('pembelian'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.pembelian-obat.create', compact('obatList', 'suppliers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('admin.pembelian-obat.index')
    ...
    public function edit($id)
    {
        ...
        return view('admin.pembelian-obat.edit', compact('pembelian', 'obatList', 'suppliers'));
    }
