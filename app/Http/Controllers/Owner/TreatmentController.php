...
class TreatmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('owner.treatment.index', compact('treatments'));
    }
    ...
    {
        return view('owner.treatment.create');
    }
    ...
    public function export(Request $request)
    {
        try {
            ...
            // Generate PDF
            $pdf = Pdf::loadView('owner.treatment.export-pdf', [
