...
class JadwalReservasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.jadwal_reservasi', compact('reservasi', 'treatments'));
    }
    ...
    public function show($id)
    {
        ...
        return view('owner.detail_reservasi', compact(
            'reservasi', 
            'totalDurasi', 
            'jamSelesai', 
            'adaPromo', 
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        try {
            ...
            elseif ($request->status === 'cancelled') {
                $alasan = $request->keterangan ?? 'Dibatalkan oleh owner';
    ...
    public function export(Request $request)
    {
        try {
            ...
            // Generate PDF
            $pdf = Pdf::loadView('owner.export-pdf', [
                'reservasi' => $reservasi,
